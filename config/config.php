...
$config = new Config([
		CONFIG_KEY_DB => [
				'adapter' => 'Mysql',
				'host' => 'rm-2zeb5prn1ze8ddp3y.mysql.rds.aliyuncs.com',
				'username' => 'root',
				'password' => 'YuanshuoIT2018',
				'dbname' => 'fichat',
				"charset" => "utf8mb4"
		],
		CONFIG_KEY_APP => [
		...
		CONFIG_KEY_HX => [
				'appKey'     => '1129170207115947#dakashe-yuanshuoit',
				'clientId'   => 'YXA67PYSYF40EeiyZAFLgghe7Q',
				'clientSecret'     =>'YXA6-0nUBmY1IfQSoq9AHZIjZK8zpAc',
				'orgName' =>'1129170207115947',
				'appName' =>'dakashe-yuanshuoit',
				'url' => 'https://a1.easemob.com/1129170207115947/dakashe-yuanshuoit/'
		],
        CONFIG_KEY_DEBUG => [
            'check_sign' => false
        ],
        CONFIG_KEY_REDIS => [
            'host' => 'r-2zefa8f8e50b37b4.redis.rds.aliyuncs.com',
            'port' => 6379,
	    'password' => 'YuanshuoIT2018'
        ],
